...
// ============================================================
//  api/auth.php
//  Handles: POST (login) | GET ?action=logout
//
//  How login works:
//   1. Receive username + password from the login form
//   2. Look up the username in the database
//   3. Use password_verify() to check the submitted password
//      against the stored hash — NEVER compare plain text
//   4. If valid → start a PHP session and redirect to dashboard
//   5. If invalid → return an error message as JSON
// ============================================================

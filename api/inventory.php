...
// ============================================================
//  api/inventory.php
//  Handles all CRUD operations for the Inventory module.
//
//  Actions:
//    GET  ?action=list       → all inventory items
//    POST action=create      → add new item
//    POST action=update      → edit item (name, unit, reorder level)
//    POST action=restock     → update quantity only (restocking)

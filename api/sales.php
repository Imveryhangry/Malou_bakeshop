...
// ============================================================
//  api/sales.php
//  Handles all Sales reporting queries.
//
//  Actions:
//    GET ?action=summary&period=daily|weekly|monthly
//    GET ?action=best_sellers&limit=10
//    GET ?action=overview   → total stats for the sales page header
// ============================================================
...
// ── OVERVIEW STATS ───────────────────────────────────────────
// Four numbers shown at the top of the sales page.
if ($action === 'overview') {
...
// ── SALES SUMMARY ────────────────────────────────────────────
// Returns a list of sales records grouped by the chosen period.
if ($action === 'summary') {

...
//
//  Actions (sent via POST or GET):
//    GET  ?action=list               → all products
//    GET  ?action=categories         → all categories (for dropdowns)
//    POST action=create              → add new product
//    POST action=update              → edit existing product
//    POST action=delete              → remove product (with safety check)
// ============================================================
...
if ($action === 'delete') {
    ...
    // Safe to delete (or soft-delete by setting status = inactive)
    // We soft-delete to preserve sales history
